package com.cosmo.cats.api.repository.impl;

import com.cosmo.cats.api.repository.NaturalIdRepository;
...
public class NaturalIdRepositoryImpl<T, ID extends Serializable> extends
    SimpleJpaRepository<T, ID> implements
    NaturalIdRepository<T, ID> {
